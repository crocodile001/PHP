...
<div id="page" class="container">
	...
	// 獲取分類名
	$cate=mysqli_query($conn,"select * from category where id=".$cate_id);
	$cate_row=mysqli_fetch_assoc($cate);
	echo '<h4>當前所在位置 : <a href="./"> 首頁 </a> > '.$cate_row['cate_name'].' </h4><br/><br/>';
	
    $sql="select * from article where cate_id=$cate_id order by intime desc limit 3";
